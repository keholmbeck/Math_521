...
\\
\problemAnswer{
    For orthogonal projections, the Gram-Schmidt process is used -- a method for generating an orthonormal basis from a set of vectors. Using the Gram-Schmidt algorithm (see the code in the Code section). We obtain the basis vectors:
    \begin{align*}
